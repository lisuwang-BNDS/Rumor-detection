...
## 搜索网页内容：<<search_result>>"""
    ...
    for json_file in tqdm(json_files):
        ...
        try:
            web_info = deepseek.chat.completions.create(
                    model="deepseek/deepseek-r1-0528:free",  # Model code
        ...
        with open(r'data\web_search_rag_predict_deepseek.json', 'a', encoding='utf-8') as f:
